...
\begin{solution}
	...
	\begin{enumerate}[label=\alph*.]
		...
		\item As $f$ is $\mathcal L=\overline{\mathcal M\otimes\mathcal N}$ measurable, by proposition $2.12$, there exists a $\mathcal M\otimes\mathcal N$ measurable function $g$ such that $f=g$ $\lambda$-a.e. which clearly implies that $f=g$ $\mu\times\nu$-a.e. as well. 
			...
			We see that $g_x$ and $g^y$ are $\mathcal M$ and $\mathcal N$ measurable respectively. 
	...
	Now we will prove the rest, proving the other implications of the first case where $f\in L^+(\lambda)$ first.
	We assume the same setup as in the lemmas proved above again. 
